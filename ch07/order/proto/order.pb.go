...
func (*GetOrderInfoReq) Descriptor() ([]byte, []int) {
	return fileDescriptor_order_c4c31069add33021, []int{0}
}
...
func (dst *GetOrderInfoReq) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetOrderInfoReq.Merge(dst, src)
}
...
func (*GetOrderInfoRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_order_c4c31069add33021, []int{1}
}
...
func (dst *GetOrderInfoRes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetOrderInfoRes.Merge(dst, src)
}
...
func init() { proto.RegisterFile("proto/order.proto", fileDescriptor_order_c4c31069add33021) }

var fileDescriptor_order_c4c31069add33021 = []byte{
