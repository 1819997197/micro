...
type SayService interface {
	...
	Will(ctx context.Context, in *Pair, opts ...client.CallOption) (*SayResponse, error)
}
...
func (c *sayService) Will(ctx context.Context, in *Pair, opts ...client.CallOption) (*SayResponse, error) {
	req := c.c.NewRequest(c.name, "Say.Will", in)
	out := new(SayResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type SayHandler interface {
	...
	Will(context.Context, *Pair, *SayResponse) error
}
...
func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		...
		Will(ctx context.Context, in *Pair, out *SayResponse) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Will(ctx context.Context, in *Pair, out *SayResponse) error {
	return h.SayHandler.Will(ctx, in, out)
}
